...
interface IGovernor is IERC165, IERC6372 {
     ...
     */
    error GovernorAlreadyCastVote(uint256 nullfier);
     ...
     */
    event VoteCast(uint256 indexed nullfier, uint256 proposalId, uint8 support, uint256 weight, string reason);
     ...
     */
    function hasVoted(uint256 proposalId, uint256 nullfier) external view returns (bool);
