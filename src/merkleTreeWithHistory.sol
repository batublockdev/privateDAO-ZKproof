 ...
 * @author batublockdev
 * @notice the following contract implements a Merkle Tree with history,
 *  allowing for the insertion of leaves and retrieval of the last root.
 * It uses Poseidon hash function for hashing leaves.
 */
